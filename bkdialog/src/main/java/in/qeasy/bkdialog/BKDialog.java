...
public class BKDialog {
    ...
    public Dialog simpleAlert(String title, String msg, String btn1, int dialogType) {
        ...
        tv_dialogTitle.setVisibility((title != null && !title.isEmpty()) ? View.VISIBLE : View.GONE);
        tv_dialogMsg.setVisibility((msg != null && !msg.isEmpty()) ? View.VISIBLE : View.GONE);
        btn_dialogBtn1.setVisibility((btn1 != null && !btn1.isEmpty()) ? View.VISIBLE : View.GONE);
    ...
    public Dialog confirmAlert(String title, String msg, String btn1, String btn2, int dialogType) {
        ...
        tv_dialogMsg.setVisibility((msg != null && !msg.isEmpty()) ? View.VISIBLE : View.GONE);
        btn_dialogBtn1.setVisibility((btn1 != null && !btn1.isEmpty()) ? View.VISIBLE : View.GONE);
        btn_dialogBtn2.setVisibility((btn2 != null && !btn2.isEmpty()) ? View.VISIBLE : View.GONE);
        btn_dialogBtn3.setVisibility(View.GONE);
    ...
    public static Dialog progressDialog(Context context, String msg) {
        return progressDialog(context, msg, false);
    }

    public static Dialog progressDialog(Context context, String msg, boolean isCancelable) {
        Dialog dialog = new Dialog(context);
